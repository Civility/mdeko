<template>
	<main class="md:py-15 py-10 container">
		<h1 class="capitalize text-main-lighter">Оплата и Доставка</h1>
		<div class="text-gray p-8 my-8 bg-gradient-to-tl from-main-darker/70 to-main/90">
			...
			<ul class="list-decimal">
				<li>
					Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus ut culpa labore molestias, alias provident, officia quod,
					eveniet distinctio rerum omnis error. Impedit quae laborum, doloremque reprehenderit quas neque nesciunt.
				</li>
				<li>
					Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus ut culpa labore molestias, alias provident, officia quod,
					eveniet distinctio rerum omnis error. Impedit quae laborum, doloremque reprehenderit quas neque nesciunt.
