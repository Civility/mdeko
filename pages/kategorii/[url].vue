...
const { pending: productWait, data: productData, refresh } = await useLazyAsyncData('product', () => getProduct(route.path))
	...
	<main class="md:py-15 py-10 container wrap">
		...
		<div class="col-span-full wrap">
			<dl class="lg:col-span-4 col-span-full border p-4 bg-gradient-to-tl from-main-darker/70 to-dark/90">
				...
				<dd>
					Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe non tempora nemo, laudantium consequuntur accusantium
					obcaecati tempore quis quod autem consequatur quibusdam vel, molestias quia accusamus atque, neque officia quisquam!
				</dd>
			</dl>
