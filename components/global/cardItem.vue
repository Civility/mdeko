<template>
	<div class="relative flex flex-col w-full mx-auto">
		<div
			class="relative rounded overflow-hidden bg-gradient-to-r even:from-main-dark/70 from-main-light/50 odd:to-main-light/50 70 group shadow-lg flex flex-col py-8"
		>
			...
			<h3
				class="my-3 py-3 text-dark uppercase after:bg-dark before:bg-dark text-center box-decoration-clone bg-gradient-to-r from-main to-sec"
				v-text="data.title"
			/>
